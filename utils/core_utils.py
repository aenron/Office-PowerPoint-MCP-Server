...
def try_multiple_approaches(operation_name: str, approaches: List[Tuple[Callable, str]]) -> Tuple[Any, str | None]:
    """
...
def safe_operation(operation_name: str, operation_func: Callable, error_message: str = "", *args, **kwargs) -> Tuple[Any, str | None]:
    """
